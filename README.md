...
### I've been suffered a lot. The editor did not send your comment to me last month and just told me to improve my paper. Then I have to re-write the whole paper. Today (June 21) I received his lettle with your comment just before I decided to submit a revision. To be honest, I did not think my paper deserve this publication when my boss (teachers) asked me to submit this manuscript. After the first revision (March 13), I thought you would give a reject to me because my newly added results were not good. However, I am grateful that you give me this opportunity. My code is simple enough because I've read so many similar papers and most of their codes have many limitation such as computational cost for pretraining or mutant structure predictions. So, please read this README carefully and it's not hard to reproduce the results because my classmates can do this without any difficulty
