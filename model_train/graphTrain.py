...
parser.add_argument('--hidden', type=int, default=128,help='Number of hidden.')
...
def train():
    ...
    for batch in range(0 ,len(mut_features)):
        ...
        # print(output)
        # print(gbdt)
        # print(len(gbdt_save), batch)
        gbdt_save[batch] = gbdt.cpu()
        # print(label)
        # print(label.shape)
        # loss_train = loss_fcn(output, residue.float())
        # print(batch, output)
...
for epoch in range(args.epochs):
    ...
    print('epoch:',epoch,'loss:',rmsd,' time cost:',tt,' pearson:', pearson, ' kandell:',ken)
