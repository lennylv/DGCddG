...
parser.add_argument('--dataset', type=str, default='exampleset', help='evaluation on test set.')
...
def validation():
    ...
    with torch.no_grad():
        for batch in range(0 ,test_mut_features.shape[0]):
            ...
            output,_ = model(m_feature, m_adj, m_adj, w_feature, nodes, mutation_site, aux)
