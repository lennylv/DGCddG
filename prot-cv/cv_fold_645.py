...
parser.add_argument('--dropout', type=float, default=0.23, help='Dropout rate (1 - keep probability).')
...
'''We performed ablation experiments to avoid over-fit on four aux features 
    under 5-fold random split cross validation:

split_seed: 42
                Mask    No_Mask
Mean PCC        0.343   0.340
Overall PCC     0.332   0.329

split_seed: 55
                Mask    No_Mask
Mean PCC        0.359   0.349
Overall PCC     0.349   0.340
'''

residue_feature[:, [0, 3]] = 0.
