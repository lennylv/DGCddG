...
'''We performed ablation experiments to avoid over-fit on four aux features, dropout rate and hidden
    under 5-fold random split cross validation:

split_seed: 42

hidden            256     512    1024
Mean PCC        0.343   0.339    0.342
Overall PCC     0.332   0.325    0.327

split_seed: 55

hidden           256     1024    
Mean PCC        0.359   0.345   
Overall PCC     0.349   0.333

We performed ablation experiments to avoid over-fit on four aux features, dropout rate and hidden under with a randomly
generated development set from trainset:
