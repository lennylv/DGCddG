...
parser.add_argument('--NODES', type=int, default=100, help='Patience')
...
if SetName == 'ab645':
    ...
    # f = open('./ab645/divided-folds.txt')
    # divid = f.read()
    # divid = eval(divid)
    # f.close()
    # split_folds = divid
...
for s in step:
    ...
    # if validation_time != args.validation :continue
    ...
    for epoch in range(args.epochs):
        loss_train = train(model, optimizer, lr_scheduler, mut_features_train, mut_adjs_train, wild_features_train, wild_adjs_train, train_labels, train_w_array, train_m_array, train_residue)
...
np.save(SetName + '_ecod_y_pred', Y_pred)
print('ending...')
