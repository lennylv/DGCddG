...
important = [i for i in range(15,65) if i not in [38,]]
mut_features = mut_features[:, important]
wild_features = wild_features[:, important]
...
for train_index, test_index in split_folds:
    ...
    for epoch in range(args.epochs):
        ...
        print('val pcc:', pcc, ' val_loss:', loss_val)
        val_pcc.append(pcc)
