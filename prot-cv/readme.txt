...
2. The divided folds of S645 is from GeoPPI project. We followed the steps provided by the authors to generate folds for S1131 and S4169. 
...
3.2 We further validate TopNetTree and GeoPPI (s4169_geoppi_features.npy was generated with the latest code, the shape is (4169, 1, 240), 240 is default selected feature number in the code) on the S4169 folds and obtained:
 PCC ~ 0.3, rmse ~ 1.70 for TopNetTree, PCC ~ 0.39, rmse ~ 1.63 for GeoPPI. The hyperparameters mentioned in the paper (like N_f, Nestimator, Depth) were tuned to obtain the result. These limited parameters may not lead to the best results. I also tried the same parameters under ten-fold Random Split and get rmse ~ 1.28 and  PCC ~ 0.7 for GeoPPI, obtained PCC~0.76 for TopGBT/TopNetTree. Therefore, it can prove the split folds generated by us are useful. It is at least strict as the folds generated by the GeoPPI authors.
