...
overall pearsonr ~ 0.3, rmse ~ 1.70 for TopNetTree, overall pearsonr ~ 0.39, rmse ~ 1.63 for GeoPPI. State again: I tried many hyperparameters mentioned in the GeoPPI paper (like N_f, Nestimator, Depth) and obtained the result. These limited parameters may not lead to the best result. I also tried the same parameters under ten-fold Random Split and get rmse ~ 1.28 and overall pearsonr ~ 0.7 for GeoPPI, get pearsonr~0.76 for TopNetTree. Therefore, it can prove the split folds generated by us are useful. It is at least strict as the folds generated by the GeoPPI authors.
...
In some cases, TopNetTree (Pearsron) may drop to -0.01 on S1131. GeoPPI may drop to 0.19 on S4169:
