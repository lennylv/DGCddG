...
parser.add_argument('--wd', type=float, default=0.3, help='Weight decay (L2 loss on parameters).')
...
pearson = scipy.stats.pearsonr(y, y_pred)[0]
print('rmse: ',rmse, ' pearson:', pearson)
torch.save(model,'./model_1470.pkl')
