...
def draw_dot(dataset):
    x = np.load('./' + dataset + '/itemlist.npy')[:, -1].astype(float)
    y = np.load('./' + dataset + '/' + dataset + '.npy').astype(float)
